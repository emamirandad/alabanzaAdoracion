...
app.controller("FirstController", function ($scope, $http, $filter) {
  ...
  $scope.selectedSongs = [];
	...
	{
		id:'85',
        nombre: 'Eres aliento en mi',
        autor: 'michael w smith',
        categoria: 'Adoracion, eres aliento en mi, estoy perdido sin ti',
        url: 'EresAlientoEnMi',
        tone:'0',
		tempo:'',
		tonalidad:'D',
    ...
    },
	{
        ...
        autor: '',
        categoria: 'Adoracion, sublime gracia del señor, de mi maldad me libero',
        url: 'SublimeGracia',
        tone:'0',
		tempo:'',
		tonalidad:'E',
	...
	{
		id:'87',
        nombre: 'Alzare mis ojos y me preguntare',
        autor: '',
        categoria: 'Adoracion, alzare mis ojos, mi socorro de donde vendra',
        url: 'AlzareMisOjos',
        tone:'0',
		tempo:'',
		tonalidad:'F#m',
    ...
    },
	{
        ...
        autor: '',
        categoria: 'Adoracion, al estar ante ti, digno es el cordero de Dios',
        url: 'AlEstarAnteTi',
        tone:'0',
		tempo:'',
		tonalidad:'D',
